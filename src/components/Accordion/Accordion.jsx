    ...
    <Accordion defaultActiveKey="0" className="accordion-width">
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body className="accordion-desc">
          ...
          Viagra and is just as effective in treating ED. In fact, the only
          difference is the price. Five Corners Rx's U.S.-based pharmacy ensures
          that our generic Viagra meets the same quality, safety, and efficacy
          standards as the brand-name version.
        </Accordion.Body>
      </Accordion.Item>
